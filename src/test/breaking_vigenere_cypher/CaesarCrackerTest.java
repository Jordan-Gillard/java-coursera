...
class CaesarCrackerTest {
    ...
    public void testDecryptEnglish() {
        FileResource fr = new FileResource("text_files/titus-small_key5.txt");
        ...
        String expected = new FileResource("text_files/titus-small.txt").asString();
        assertEquals(expected, decryptedText);
    }

    @Test
    public void testDecryptPortuguese() {
        FileResource fr = new FileResource("text_files/oslusiadas_key17.txt");
        String encryptedText = fr.asString();
        CaesarCracker caesarCracker = new CaesarCracker('a');
        String decryptedText = caesarCracker.decrypt(encryptedText);
        FileResource frExpected = new FileResource("text_files/oslusiadas.txt");
